...
import static org.intelehealth.app.feature.video.utils.CallConstants.RTC_ARGS;
...
//        }
    ...
    private void showAppClosingDialog() {
        new MaterialAlertDialogBuilder(this)
                ...
                .setPositiveButton(R.string.yes, (dialog, which) -> sayBye("Call ended by you", null)).setNegativeButton(R.string.no, null).create().show();
    }
