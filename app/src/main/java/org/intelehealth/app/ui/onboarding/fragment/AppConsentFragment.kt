...
import org.intelehealth.app.databinding.FragmentAppConsentBinding
 ...
 */
@AndroidEntryPoint
class AppConsentFragment : ConsentFragment(R.layout.fragment_app_consent) {
    private lateinit var binding: FragmentAppConsentBinding
    private val navArgs: AppConsentFragmentArgs by navArgs<AppConsentFragmentArgs>()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        binding = FragmentAppConsentBinding.bind(view)
    ...
    override fun navigateToSelf(args: ConsentArgs) {
        findNavController().navigate(AppConsentFragmentDirections.actionToSelf(args))
    }
}
