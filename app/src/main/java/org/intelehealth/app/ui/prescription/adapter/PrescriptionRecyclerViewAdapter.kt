 ...
 *
 * RecyclerView adapter for displaying a list of [VisitDetail] items.
 *
 ...
 * @param visitDetails The initial list of prescriptions to display. This list can be updated.
 */
class PrescriptionRecyclerViewAdapter(
    context: Context,
    private var visitDetails: MutableList<VisitDetail>
) : BaseRecyclerViewAdapter<VisitDetail>(context, visitDetails) {
     ...
     */
    fun updateList(newList: MutableList<VisitDetail>) {
        val oldListSize = visitDetails.size // Correctly get size before adding
        visitDetails.addAll(newList)
