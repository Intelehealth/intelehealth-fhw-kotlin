...
//        CustomLog.i(TAG, "Reading from file");
        ...
        try {
            File myDir = new File(context.getFilesDir().getAbsolutePath() + File.separator + AppConstantsKt.JSON_FOLDER + File.separator + FILENAME);
...
//            CustomLog.i("FILEREAD>", s);
    ...
    public static JSONObject encodeJSON(Context context, String fileName) {
        ...
        try {
            ...
            Toast.makeText(context, context.getString(org.intelehealth.resource.R.string.content_config_file_missing), Toast.LENGTH_SHORT).show();
            FirebaseCrashlytics.getInstance().recordException(e);
        }
